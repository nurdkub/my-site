      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "0 24px", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", gap: 16, height: 60 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
            <a href="/login" style={{ padding: "8px 16px", fontSize: 14, border: "1px solid #e5e7eb", borderRadius: 8, textDecoration: "none", color: "#374151" }}>
              Войти
            </a>
            <a href="/register" style={{ padding: "8px 16px", fontSize: 14, background: "#2563eb", color: "#fff", borderRadius: 8, textDecoration: "none" }}>
              Подать объявление
            </a>
          </div>
        </div>
